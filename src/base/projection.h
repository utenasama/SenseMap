...
#ifndef SENSEMAP_BASE_PROJECTION_H_
#define SENSEMAP_BASE_PROJECTION_H_
...
// For camera rig, in the current version, the qvec and tvec should be 
// computed outside for the local camera. will be moved inside in the 
// future
...
// Calculate angulate error using points on shpeical bearing
...
#endif  // SENSEMAP_BASE_PROJECTION_H_
