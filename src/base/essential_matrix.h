...
#ifndef SENSEMAP_BASE_ESSENTIAL_MATRIX_H_
#define SENSEMAP_BASE_ESSENTIAL_MATRIX_H_
...
void PoseFromEssentialMatrixSphericalCamera(const Eigen::Matrix3d& E,
...
#endif  // SENSEMAP_BASE_ESSENTIAL_MATRIX_H_
