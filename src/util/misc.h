...
#ifndef SENSEMAP_UTIL_MISC_H_
#define SENSEMAP_UTIL_MISC_H_
...
// Check whether a given file path is inside a certain subpath
// e.g. "dir1/file2.jpg" is inside subpath "dir1"
...
// Extract Timestamp from Video Name for SenseMap
std::string GetVideoTimeStampFromPath(const std::string& path);

// Extract Timestamp from Image Name for SenseMap
...
// Print sensemap heading with over- and underscores to `std::cout`.
...
// Print third-order heading with underscores to `std::cout`.
