...
#ifndef SENSEMAP_MVS_AABB_H_
#define SENSEMAP_MVS_AABB_H_
...
typedef class TAABB<REAL, 2> AABB2;
typedef class TAABB<REAL, 3> AABB3;
typedef class TAABB<float, 2> AABB2f;
typedef class TAABB<float, 3> AABB3f;

} // namespace mvs
} // namespace sensemap

#endif // SENSEMAP_MVS_AABB_H_
