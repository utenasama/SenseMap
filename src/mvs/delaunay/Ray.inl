...
inline TTriangle<TYPE,DIMS>::TTriangle(const TTriangle<TYPE,DIMS>::POINT& p0, const TTriangle<TYPE,DIMS>::POINT& p1, const TTriangle<TYPE,DIMS>::POINT& p2)
    :
    a(p0), b(p1), c(p2)
{
} // constructors
...
// set attributes
template <typename TYPE, int DIMS>
inline void TTriangle<TYPE,DIMS>::Set(const TTriangle<TYPE,DIMS>::POINT& p0, const TTriangle<TYPE,DIMS>::POINT& p1, const TTriangle<TYPE,DIMS>::POINT& p2)
{
    a = p0;
    b = p1;
    c = p2;
