...
#ifndef SENSEMAP_MVS_LIST_H_
#define SENSEMAP_MVS_LIST_H_
...
#define CLISTDEF0(TYPE) sensemap::mvs::cList< TYPE, const TYPE&, 0 >
#define CLISTDEF2(TYPE) sensemap::mvs::cList< TYPE, const TYPE&, 2 >
#define CLISTDEF0IDX(TYPE,IDXTYPE) sensemap::mvs::cList< TYPE, const TYPE&, 0, 16, IDXTYPE >
#define CLISTDEFIDX(TYPE,IDXTYPE) sensemap::mvs::cList< TYPE, const TYPE&, 1, 16, IDXTYPE >
#define CLISTDEF2IDX(TYPE,IDXTYPE) sensemap::mvs::cList< TYPE, const TYPE&, 2, 16, IDXTYPE >
...
typedef class cList<void*, void*, 0>        VoidArr;
typedef class cList<IDX, IDX, 0>            IDXArr;
typedef class cList<uint8_t, uint8_t, 0>    Unsigned8Arr;
typedef class cList<unsigned, unsigned, 0>  UnsignedArr;
typedef class cList<uint32_t, uint32_t, 0>  Unsigned32Arr;
typedef class cList<uint64_t, uint64_t, 0>  Unsigned64Arr;
typedef class cList<size_t, size_t, 0>      SizeArr;
typedef class cList<int, int, 0>            IntArr;
typedef class cList<bool, bool, 0>          BoolArr;
typedef class cList<float, float, 0>        FloatArr;
typedef class cList<double, double, 0>      DoubleArr;

} // namespace mvs
} // namespace sensemap

#endif // SENSEMAP_MVS_LIST_H_
