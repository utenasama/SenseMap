...
#ifndef SENSEMAP_MVS_PLANE_H_
#define SENSEMAP_MVS_PLANE_H_
...
public:
    ...
    typedef mvs::TPlane<TYPE,3> PLANE;
    typedef mvs::TSphere<TYPE,3> SPHERE;
    typedef mvs::TAABB<TYPE,3> AABB;
