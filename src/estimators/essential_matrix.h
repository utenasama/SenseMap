...
#ifndef SENSEMAP_ESTIMATORS_ESSENTIAL_MATRIX_H_
#define SENSEMAP_ESTIMATORS_ESSENTIAL_MATRIX_H_
...
// Adaption for spherical camera
class SphericalEssentialMatrixFivePointEstimator {
 public:
...
#endif  // SENSEMAP_ESTIMATORS_ESSENTIAL_MATRIX_H_
