...
std::vector<SphericalEssentialMatrixFivePointEstimator::M_t>
SphericalEssentialMatrixFivePointEstimator::Estimate(
...
void SphericalEssentialMatrixFivePointEstimator::Residuals(
    const std::vector<X_t>& points1, const std::vector<Y_t>& points2,
    const M_t& E, std::vector<double>* residuals) {
  ComputeAngularError(points1,points2,E,residuals);
}
