...
#ifndef SENSEMAP_ESTIMATORS_TRIANGULATION_H_
#define SENSEMAP_ESTIMATORS_TRIANGULATION_H_
...
class TriangulationEstimator {
 public:
  ...
  struct PointData {
    ...
    // Observation on bearing.
    Eigen::Vector3d point_bearing;
  };
...
#endif  // SENSEMAP_ESTIMATORS_TRIANGULATION_H_
