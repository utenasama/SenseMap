...
#ifndef SENSEMAP_OPTIM_SOLVER_SPARSE_CHOLESKY_LLT_H_
#define SENSEMAP_OPTIM_SOLVER_SPARSE_CHOLESKY_LLT_H_
...
#endif //SENSEMAP_OPTIM_SOLVER_SPARSE_CHOLESKY_LLT_H_
