...
#ifndef SENSEMAP_OPTIM_RANSAC_RANSAC_H_
#define SENSEMAP_OPTIM_RANSAC_RANSAC_H_
...
struct RANSACOptions {
  ...
  // best model is above a threshold
  double min_inlier_ratio_to_best_model = 0.55;
...
class RANSAC {
 public:
  struct Report {
    ...
    // The estimated multiple models.
    std::vector<typename SupportMeasurer::Support> multiple_supports;
    std::vector<typename Estimator::M_t> multiple_models;
  };
...
#endif  // SENSEMAP_OPTIM_RANSAC_RANSAC_H_
