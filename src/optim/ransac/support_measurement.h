...
#ifndef SENSEMAP_OPTIM_RANSAC_SUPPORT_MEASUREMENT_H_
#define SENSEMAP_OPTIM_RANSAC_SUPPORT_MEASUREMENT_H_
...
#endif  // SENSEMAP_OPTIM_RANSAC_SUPPORT_MEASUREMENT_H_
